        ...
        else if (strcmp(token, "pwd") == 0)
        {
			...
			if(pid==0){
                if(strcmp(token,"ls")==0){
                    ...
                    token=strtok(NULL," ");
                    execl("/Users/mahiryadav/repos/OS_assignment_2/cat",token,input[1],NULL);
                }
                    ...
                    token=strtok(NULL," ");
                    execl("/Users/mahiryadav/repos/OS_assignment_2/rm",token,input,NULL);
                    
                }
                else if(strcmp(token,"mkdir")==0){
                    token=strtok(NULL," ");
                    execl("/Users/mahiryadav/repos/OS_assignment_2/mkdir",token,input,NULL);
